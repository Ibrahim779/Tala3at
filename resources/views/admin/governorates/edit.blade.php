...
@section('title', 'Governorate Edit')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">Edit Governorate</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 pr-md-1">
                                <div class="form-group">
                                    ...
                                    <input value="{{$governorate->title_ar?:old('name_ar')}}" name="name_ar"
                            ...
                            <div class="col-md-6 pl-md-1">
                                <div class="form-group">
                                    ...
                                    <input value="{{$governorate->title_en?:old('name_en')}}" name="name_en"
